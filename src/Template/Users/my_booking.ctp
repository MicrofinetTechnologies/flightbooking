    ...
    @media screen and (max-width: 767px) {
        ...
        <section id="search-results-body" style="margin: 50px 0 60px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-lg-9">
                        ...
                        <ul class="nav nav-tabs" id="innerTab">
                            <li class="active"><a data-toggle="tab" href="#active-trips" class="active"><?php echo __('Flights'); ?> (<span id="pst_cnt"><?= !empty($fli_cnt) ? $fli_cnt : 0; ?> </span>)</a></li>
                            <li><a data-toggle="tab" href="#pending-trips"><?php echo __('Accommodations'); ?> (<?= !empty($all_pro_booking->count()) ? $all_pro_booking->count() : 0; ?>)</a></li>
            ...
            <!--                                                <div class="modal fade bd-example-modal-lg"  id="flightDetailsModal<?= $details->id; ?>" tabindex="-1" role="dialog" aria-labelledby="flightDetailsModalLabel" aria-hidden="true">
                            ...
                            <div id="pending-trips" class="tab-pane fade in">
                                <!--Property booked -->
                                <?php
                                    ...
                                    <div class="hotel-lsting">
                                        ...
                                        <div class="hotel-lsting-middle">
                                            ...
                                            <h6><span><a href="#"><?= $property_details->property_size; ?> <?php echo __('Sqm') ?></a>
                                                    ...
                                                    <?php } else if ($property_details->description->rating >= 3) { ?><h5 style="background-color: #ffc107 !important;font-size: 15px;width: 62%;margin-top: 8px;text-transform: capitalize;"><a href="#"><?php echo __('Medium Quality') ?></a></h5> 
                                                        ...
                                                        <div class="form-group" style="margin: 0 9px 0px 0px;">
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <?php if ($this->User->check_review($pro_book->booking_no) >= 1) { ?>
                                                                    <button type="button" class="btn btn-primary hvr-grow btn-fill" style="margin: -16px 0px 20px 0px;"> Paid</button>
                                                                <?php } else { ?>
                                                            ...
                                                            <table class="line line-1">
                                                                <tbody><tr>
                                                                        ...
                                                                        <td rowspan="2">
                                                                            ...
                                                                            <p class="rangeTime"><span class="hours">10 h 45 m</span>m</p>
                                                            ...
                                                            <table class="line line-1">
                                                                <tbody><tr>
                                                                        ...
                                                                        <td rowspan="2">
                                                                            ...
                                                                            <p class="rangeTime"><span class="hours">20 h 5 m</span>m</p>
