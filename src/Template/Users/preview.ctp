    ...
    <!--                                                    <div class="Best-Deal"><a href="#"><i class="fa fa-dollar"></i>Best Deal</a></div>-->
                                            ...
                                            ?>                 </span>
                                                        ...
                                                        <p class="text text-success" style="font-weight: normal;font-size: 15px;">
                                                            ...
                                                            if($dateDifference>=$longDays){
                                                                if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                    echo $this->request->session()->read("CURRENCY") . ' ' . number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $dateDifference * $htl_fixrm_pric), 2);?> <?= ' '. __("for"); ?> <?= $dateDifference; ?><?php
                                                                } else {
                                                                    echo 'AOA ' . $this->User->changeFormat(number_format($dateDifference * $htl_fixrm_pric, 2));?> <?= ' '. __("for"); ?> <?= $dateDifference; ?><?php
                                                                }
                                                            }else{
                                                                if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                    echo $this->request->session()->read("CURRENCY").' '.number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), ($dateDifference * ($htl_rm_pric - ($htl_rm_pric * ($htl_rm_pric_frea / 100))))), 2);?> <?= ' '. __("for"); ?> <?= $dateDifference; ?><?php
                                                                } else {
                                                                    echo 'AOA '. $this->User->changeFormat(number_format($dateDifference  * ($htl_rm_pric - ($htl_rm_pric * ($htl_rm_pric_frea / 100))), 2)); ?> <?= ' '. __("for"); ?> <?= $dateDifference; ?><?php
                                                                }
                                                            ?> 
                                                            <?php } ?>                                                             
                                                           ...
                                                           <?php } else { ?>
                                                            ...
                                                            if($dateDifference>=$longDays){
                                                                ...
                                                                if (!empty($this->request->session()->read("CURRENCY"))) {
                                                                    echo $this->request->session()->read("CURRENCY").' '.number_format($this->User->priceConvert($this->request->session()->read("CURRENCY"), $dateDifference * $htl_rm_pric), 2);?> <?= ' '. __("for"); ?> <?= $dateDifference; ?> <?php
                                                                } else {
                                                                    echo 'AOA '. $this->User->changeFormat(number_format($dateDifference * $htl_rm_pric, 2));?> <?= ' '. __("for"); ?> <?= $dateDifference; ?> <?php 
                                                                }
                                                            ?><?php
                                                            }
                                                            }
